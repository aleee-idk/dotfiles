...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim_context_vt', 'gitsigns.nvim', 'Comment.nvim', 'spellsitter.nvim', 'nvim-neoclip.lua', 'indent-blankline.nvim', 'nvim-treesitter-context', 'todo-comments.nvim', 'lsp_signature.nvim', 'nvim-ts-hint-textobject', 'nvim-ts-rainbow', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-ts-context-commentstring'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'numb.nvim', 'sidebar.nvim', 'surround.nvim', 'focus.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
