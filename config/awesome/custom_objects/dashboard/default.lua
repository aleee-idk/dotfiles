...
-- Helper box container -- {{{
    ...
    local user_box = create_boxed_widget(user_widget, size.large.w, size.large.h, x.background)
    ...
    local calendar_box = create_boxed_widget(calendar, size.large.w, size.large.h, x.background)
    ...
    local disk_box = create_boxed_widget(disk, size.small.w, size.small.w, x.background)
    ...
    local bookmarks_box = create_boxed_widget(bookmarks, size.medium.w, size.medium.h, x.background)
    ...
    local uptime_box = create_boxed_widget(uptime, size.small.w, size.small.h, x.background)
