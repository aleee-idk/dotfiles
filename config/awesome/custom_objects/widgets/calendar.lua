...
styles.month   = {
    padding      = 20,
    fg_color     = beutiful.color7,
    bg_color     = beutiful.background.."00",
    border_width = 0,
}
styles.normal  = {}
styles.focus   = {
    fg_color = beutiful.color1,
    bg_color = beutiful.color5..00,
    markup   = function(t) return '<b>' .. t .. '</b>' end,
}
styles.header  = {
    fg_color = beutiful.color4,
    bg_color = beutiful.color1.."00",
    -- markup   = function(t) return '<b>' .. t .. '</b>' end,
...
local function decorate_cell(widget, flag, date)
    ...
    local default_fg = beutiful.color7
    local default_bg = beutiful.color0.."00"
    ...
    local ret = wibox.widget {
        ...
        shape              = props.shape,
        shape_border_color = props.border_color or beutiful.background,
