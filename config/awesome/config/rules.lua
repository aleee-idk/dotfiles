...
return {
    ...
    }, -- Floating clients.
    {
        rule_any = {
            instance = {
                ...
                "pinentry", "Devtools" -- Firefox devtools
            },
            class = {
                "Thunar", "Godot", "Arandr", "Blueman-manager", "Gpick",
                "Kruler", "MessageWin", -- kalarm.
                "Sxiv", "Tor Browser", -- Needs a fixed window size to avoid fingerprinting by screen size.
                "Wpa_gui", "veromix", "xtightvncviewer", "files", -- Custom Class for some terminals
                "vimiv" -- image Viewer
            },
    ...
    }, -- Centered Clients
    {
        rule_any = {
            type = {"dialog"},
            class = {"Steam", "music", "scratchpad"},
            instance = {"music", "scratchpad"}
        },
    ...
    {
        rule_any = {type = {"dialog"}, class = {"firefox"}},
        callback = function(c)
    ...
    {
        rule_any = {
            class = {"TelegramDesktop", "whatsapp-nativefier-d40211", "discord"}
        },
        properties = {screen = 2, tag = "8"}
    }, -- Music
    {rule_any = {class = {"music", "Spotify"}}, properties = {tag = "10"}},
    -- Video
    {rule_any = {class = {"mpv"}}, properties = {ontop = true, tag = "9"}},
