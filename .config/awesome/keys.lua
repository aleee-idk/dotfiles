...
keys.global_keys = gears.table.join(
    ...
    awful.key({ modkey, ctrlKey }, "h", 
        ...
        { description = "Focus window to the left", group = "Windows" }
    ),
    awful.key({ modkey, ctrlKey }, "j", 
        function ()
            awful.screen.focus_bydirection("down")
        end,
        { description = "Focus window to the bottom", group = "Windows" }
    ),
    awful.key({ modkey, ctrlKey }, "k", 
        function ()
            awful.screen.focus_bydirection("up")
        end,
        { description = "Focus window to the top", group = "Windows" }
    ),
    awful.key({ modkey, ctrlKey }, "l", 
        function ()
            awful.screen.focus_bydirection("right")
        end,
        { description = "Focus window to the right", group = "Windows" }
    ),
...
for i = 1, 10 do
    ...
    keys.global_keys = gears.table.join(keys.global_keys,
        ...
        -- Move all clients to tag and focus that tag
        awful.key({ modkey, altKey }, "#" .. i + 9,
            ...
            {description = "Move all visible clients to tag #"..i, group = "Tags"}
        ),
